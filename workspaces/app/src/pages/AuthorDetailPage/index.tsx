...
const AuthorDetailPage: React.FC = () => {
  ...
  const imageUrl = useImageSrc({ height: 128, imageId: author.image.id, width: 128 });
  ...
  return (
    <Box height="100%" px={Space * 2}>
      <_HeadingWrapper aria-label="作者情報">
        {imageUrl != null && (
          <_AuthorImageWrapper>
            <Image key={author.id} alt={author.name} loading='lazy' height={128} objectFit="cover" src={imageUrl} width={128} />
          </_AuthorImageWrapper>
        )}
